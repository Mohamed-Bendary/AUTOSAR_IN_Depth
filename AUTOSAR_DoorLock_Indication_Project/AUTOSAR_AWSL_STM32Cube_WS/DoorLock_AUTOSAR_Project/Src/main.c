...
#include "../AUTOSAR_Implementation/RTE_Generated/Rte_DoorSensorAbstractionSWC.h"
#include "../AUTOSAR_Implementation/RTE_Generated/Rte_DoorLock_Indication_SWC.h"
